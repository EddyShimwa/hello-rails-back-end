...
**hello-rails-back-end is an api app which  serve as the api to be called by the react app** 
...
```sh
  cd my-folder
  git clone https://github.com/EddyShimwa/hello-rails-back-end.git
```
...
Feel free to check the [issues page](https://github.com/EddyShimwa/hello-rails-back-end/issues).
